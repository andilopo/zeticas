    ...
    return (
        <div className="nosotros-page botanical-bg" style={{ minHeight: '100vh', padding: 'var(--spacing-container) 0' }}>
            <div className="container">
                ...
                {/* ZetaMovil Section */}
                <section style={{ marginTop: '8rem', textAlign: 'center', position: 'relative' }}>
                    <div style={{
                        position: 'absolute',
                        top: '-100px',
                        left: '-10%',
                    ...
                    <img
                        src={farmPhoto}
                        alt="Finca Zeticas"
                        style={{ width: '100%', maxHeight: '400px', objectFit: 'cover', borderRadius: '24px', marginBottom: '3rem', boxShadow: '0 10px 30px rgba(0,0,0,0.1)' }}
                    />
